...
import com.github.gpluscb.smashggnotifications.ultimateframedata.CharacterData;
...
public class CharacterCommand implements Command {
    ...
    public String[] getAliases() {
        return new String[]{"character", "char", "ufd", "moves", "hitboxes"};
    }
    ...
    public String getDetailedHelp() {
        return "`char[acter]|ufd|moves|hitboxes <CHARACTER NAME...> [MOVE NAME...]`\n" +
